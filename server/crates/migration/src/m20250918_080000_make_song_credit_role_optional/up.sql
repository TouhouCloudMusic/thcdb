...
ALTER TABLE "public"."song_credit"
  ALTER COLUMN "id"
SET NOT NULL,
  ADD CONSTRAINT "song_credit_pkey" PRIMARY KEY ("id");
...
UPDATE "public"."song_credit_history" SET
  "id" = DEFAULT
WHERE "id" IS NULL;
...
ALTER TABLE "public"."song_credit_history"
  ALTER COLUMN "id"
SET NOT NULL,
  ADD CONSTRAINT "song_credit_history_pkey" PRIMARY KEY ("id");

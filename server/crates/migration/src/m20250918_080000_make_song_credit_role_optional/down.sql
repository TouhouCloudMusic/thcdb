...
ALTER TABLE "public"."song_credit"
...
ALTER TABLE
  "public"."song_credit"
  ADD CONSTRAINT "song_credit_pkey" PRIMARY KEY ("song_id", "artist_id", "role_id");
...
ALTER TABLE "public"."song_credit_history"
...
ALTER TABLE
  ...
  ADD CONSTRAINT "song_credit_history_pkey" PRIMARY KEY ("history_id", "artist_id", "role_id");

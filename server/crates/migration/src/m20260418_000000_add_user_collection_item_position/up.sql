ALTER TABLE
  "public"."user_list" RENAME TO "user_collection";
...
ALTER TABLE
  "public"."user_list_item" RENAME TO "user_collection_item";
...
UPDATE
  "public"."user_collection_item" AS "item"
SET
  "position" = "ranked"."position"
FROM
  ranked_items AS "ranked"
WHERE
  "item"."id" = "ranked"."id";
...
ALTER TABLE
  "public"."user_collection_item"
ADD
  CONSTRAINT "user_collection_item_user_collection_id_position_key" UNIQUE ("user_collection_id", "position") DEFERRABLE INITIALLY IMMEDIATE;

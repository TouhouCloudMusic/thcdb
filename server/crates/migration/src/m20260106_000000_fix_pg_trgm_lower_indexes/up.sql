...
CREATE INDEX idx_release_title_gist
    ON "public"."release"
    USING gist (lower("title") gist_trgm_ops);
...
CREATE INDEX IF NOT EXISTS idx_song_localized_title_gist
    ON "public"."song_localized_title"
    USING gist (lower("title") gist_trgm_ops);

CREATE INDEX IF NOT EXISTS idx_credit_role_name_gist
    ON "public"."credit_role"
    USING gist (lower("name") gist_trgm_ops);
